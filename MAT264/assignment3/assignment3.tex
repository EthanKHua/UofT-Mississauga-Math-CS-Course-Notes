...
\begin{tikzpicture}
    ...
    \foreach \x/\label in {0/\(x_0\), 1/\(x_0 + h\), 2/\(x_0 + 2h\), 3/\(x_0 + 3h\), 4/\(x_0 + \frac{3}{2}h\)} {
        \draw (\x,0.1) -- (\x,-0.1);
...
\begin{tikzpicture}
    ...
    \foreach \x/\label in {0/\(x_0\), 1/\(x_0 + \alpha h\), 3/\(x_0 + 2h\)} {
        \draw (\x,0.1) -- (\x,-0.1);
        \node[below] at (\x,-0.1) {\label};
    }
\end{tikzpicture}
...
\begin{tikzpicture}
    \draw[<->] (-1,0) -- (4,0) node[below] {\( x \)};
    \foreach \x/\label in {0/\(x_0\), 1/\(x_0 + \frac{4}{3}h\), 3/\(x_0 + 2h\)} {
        \draw (\x,0.1) -- (\x,-0.1);
        \node[below] at (\x,-0.1) {\label};
    }
\end{tikzpicture}
