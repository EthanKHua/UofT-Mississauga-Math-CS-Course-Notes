...
\begin{document}
    ...
    \begin{question}{1}
        ...
        First, we pick our 5 distinct ranks, which there are \({13\choose 5}\) different ways to do so. After picking the 5 ranks, we want to choose 3 red cards and 2 black cards. For each rank, there are 2 ways to choose a red card and 2 ways to choose a black card. Since we are choosing a total of 5 cards, no matter if we are choosing 3, 4, or 5 red cards, the number of ways turns out to be \(2^5\). For each case, the number of ways comes out to be \({13 \choose 5}2^5\), and there are 3 cases in total. Thus we can add all the cases together to get that the answer is
        \[
            {13 \choose 5} \cdot 3 \cdot 2^5
        \]
    \end{question}
    \newpage
    \begin{question}{2}
