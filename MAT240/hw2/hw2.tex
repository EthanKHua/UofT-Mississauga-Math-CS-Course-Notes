...
\begin{document}
    ...
    \begin{question}{5}
        ...
        Let \(I\) be a linearly independent set. Then \(W = \mathrm{span} (I)\) is a subspace of \(V\) with basis \(I\). By part (a), we can extend \(I\) to a basis \(\beta\) of \(V\), where \(\beta = I \cup \alpha\), 
    \end{question}
    \newpage
    \begin{question}{6}
