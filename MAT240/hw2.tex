...
\begin{document}
    ...
    \begin{question}{2}
        ...
        \(S = \left\{ \begin{pmatrix*}[r]
                      ...
                      \begin{pmatrix*}[r]
                        ...
                        1 \\
                      \end{pmatrix*}\right\} \).
        Since both vectors are solutions to the homogeneous equation in \(W\), \(S \subseteq W\).
    \end{question}
    \newpage
    \begin{question}{3}
    ...
    \begin{question}{6}
        ...
        Prove that if \( M = \begin{pmatrix} 
        A & B \\ C & D 
        \end{pmatrix} \) and \( N = \begin{pmatrix} 
        A' & B' \\ C' & D' 
        \end{pmatrix} \), then \( \alpha M + N = \begin{pmatrix} 
        \alpha A + A' & \alpha B + B' \\ \alpha C + C' & \alpha D + D' 
        \end{pmatrix} \).
    \end{question}
    \newpage
    \begin{question}{7}
    ...
    \newpage
    \begin{question}{10}
        Let \( J = \left( \begin{array}{c|c} O & -I_2 \\ I_2 & O \end{array} \right) \) and \( \mathbb{F} = \mathbb{C} \).
        ...
        For Question 10, you may use the following fact about block matrices without proof (you will prove it in the future):
        
        \[
        \left( \begin{array}{cc} A & B \\ C & D \end{array} \right) \left( \begin{array}{cc} K & L \\ M & N \end{array} \right) = \left( \begin{array}{cc} AK + BM & AL + BN \\ CK + DM & CL + DN \end{array} \right).
        \]
    \end{question}
    \newpage
    \begin{question}{11}
