...
\begin{document}
    ...
    \begin{question}{7}
        ...
        \[
            r_{n-2} = qr_{n-1} + r_n
        \]
        This is well-defined, as the choices for \(q\) and \(r_n\) are unique. As well, this sequence is eventually strictly decreasing. That is, for \(n > 0\), \(r_n > r_{n+1}\), so we see that this sequence eventually reaches 0. 
