...
\begin{document}
    ...
    \begin{question}{7}
        ...
        \[
            r_{n-2} = qr_{n-1} + r_n
        \]
        This is well-defined, as the choices for \(q\) and \(r_n\) are unique. 
    ...
    \begin{question}{8}
        ...
        \begin{align*}
            ...
            &= \left(x^4 + 2x^3 + x^2 + 1 + \left( \frac{1}{2}x + 1 \right)\cdot (-2x^3)\right) - \frac{1}{2}x \cdot (2x \cdot (x^2 + 1 - 2x^3))\\
            &= 
        \end{align*}
    \end{question}
    \newpage
