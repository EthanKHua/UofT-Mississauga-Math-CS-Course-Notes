...
\begin{document}
    ...
    \begin{question}{19}
        ...
        \]
        so it follows that \(S_n\) is closed.
        ...
        As \(n\) tends to infinity, \(S_n = \left\{x \in U : \mathrm{dist}(\{x\}, U^c) > 0\right\}\) which is exactly \((U^c)^c = U\). Therefore \(U\) has compact exhaustion.
        \tcblower
        (b):
    \end{question}
    \pagebreak
