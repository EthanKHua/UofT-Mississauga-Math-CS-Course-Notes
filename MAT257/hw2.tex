...
\begin{document}
    ...
    \begin{exercise}
        ...
        \begin{enumerate}[label=(\alph*)]
            ...
            \begin{proof}
                It suffices to show that for \(T, U \in B(X,Y)\), \(\left\lVert T \right\rVert _{op} = 0 \iff T = 0\) and \(\left\lVert T+U \right\rVert _{op} \leq  \left\lVert T \right\rVert _{op} + \left\lVert U \right\rVert _{op}\).
            ...
            \begin{proof}
                Let \(X=Y=\mathbb{R} ^n\).
                Let \(\left\lVert \cdot \right\rVert _X=\left\lVert \cdot \right\rVert _2\) and
