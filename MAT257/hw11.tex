...
\begin{document}
    ...
    \begin{question}{30}
		...
		\[
			\beta (p) = 0
		\]
		as desired. Now, we can proceed proving the main result.

		Let \(U\) be an open subset of \(\mathbb{R}^n\), and let \(K \subseteq U\) be compact. For every \(y \in K\), there exists an open ball centered around \(y\) so that \(B(y, \delta) \subseteq U\).
    \end{question}
	\newpage
	\begin{question}{31}
