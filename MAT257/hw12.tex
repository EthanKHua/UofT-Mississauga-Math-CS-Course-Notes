...
\begin{document}
	...
	\begin{question}{33}
        ...
        \]
        We will attempt to minimize and maximize \(f(x,y,z) = x^2 + y^2 + z^2\) on \(M\). By part (a), there exists \(\lambda \in \mathbb{R}\) so that
        \[
        ...
        \begin{equation*}
            x = y + z
        \end{equation*}
        Substitute this into the ellipsoid to get
        \[
            (y + z)^2 + yz + y^2 - (y + z)y - (y + z)z + z^2 = 3
        \]
        \[
            \implies y^2 + yz + z^2 = 3
        \]
        We take the first and second equation and add them together to obtain
        \[
    ...
    \begin{question}{34}
        ...
        Suppose for contradiction that \(n > m\) and \(\Phi\) is an injective function.
    \end{question}
\end{document}